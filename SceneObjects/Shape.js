class Shape extends SceneObject {
  ...
  copy() {
    let copy = new Shape(this.gl);
    copy.initData(this.initVertices, this.initColors, this.initNormals);
    mat4.copy(copy.modelMatrix, this.modelMatrix);
    mat4.copy(copy.scaleMatrixLocal, this.scaleMatrixLocal);
    mat4.copy(copy.scaleMatrixGlobal, this.scaleMatrixGlobal);
